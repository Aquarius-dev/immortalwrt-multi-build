...
WIFI_SSID="${WIFI_SSID:-NETGEAR_5G}"
WIFI_KEY="${WIFI_KEY:-CHANGE_ME}"
WIFI_ENCRYPTION="${WIFI_ENCRYPTION:-psk2}"
WIFI_CIPHER="${WIFI_CIPHER:-ccmp}"
...
uci set wireless.$IFACE.mobility_domain='0x1221'
uci set wireless.$IFACE.reassociation_deadline='20000'
